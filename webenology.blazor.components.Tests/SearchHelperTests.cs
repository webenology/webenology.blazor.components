...
public class SearchHelperTests
{
    ...
    public SearchHelperTests(ITestOutputHelper testOutputHelper)
    {
    ...
    [Fact]
    public void it_should_do_simple_search_2()
    {
        var searchKey = "ab is";
        var items = new List<string>
        {
    ...
    [Fact]
    private void it_should_do_a_large_search_2()
    {
        var sw = new Stopwatch();
        sw.Start();
        var item =
    ...
    private void it_should_do_a_large_search_3()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            {
                var src = search[0..y];
                var results = listOfItems.Search(src, x => x);
            }

            // sw.Stop();
            //
            // took.Add(sw.Elapsed);
            // _testOutputHelper.WriteLine($"invocation: {i}, took {sw.Elapsed}");
