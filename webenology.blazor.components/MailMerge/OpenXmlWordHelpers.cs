...
internal static class OpenXmlWordHelpers
{
    ...
    public static IEnumerable<OpenXmlElement> GetMergeFields(this WordprocessingDocument doc, string mergeFieldName = null)
    {
        if (doc == null)
            return null;

        var fields = new List<OpenXmlElement>();
    ...
    public static string ScrubText(this string text)
    {
        text = text.Replace("MERGEFIELD", "");
        text = text.Replace("\\*", "");
